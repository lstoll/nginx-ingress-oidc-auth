...
1. Download [Prebuilt Binary](https://github.com/lstoll/nginx-ingress-oidc-auth/releases) (current release is `v2.2`) or build with `$ go get github.com/lstoll/nginx-ingress-oidc-auth` which will put the binary in `$GOROOT/bin`
